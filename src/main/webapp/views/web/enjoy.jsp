...
<link rel="stylesheet"
	href="<c:url value='/templates/web/css/sortproduct.css' />">
<link rel="stylesheet"
	href="<c:url value='/templates/web/css/pagination.css' />">

<div class="toast-wrap"></div>
<div class="grid wide">
	<div class="direct">
		<span>Trang chủ</span> / <span>yêu thích</span>
	</div>
	<div class="row">
		...
		<div class="col l-9 m-8 c-12 min-12">
			...
			<div class="sort-product">
				<ul class="sort-product__list">
					...
					<li class="sort-product__item active">Mặc định
			...
			<ul class="pagination">
				<li class="pagination__item pagination--active"><a href=""
					class="pagination__link">1</a></li>
				<li class="pagination__item"><a href=""
					class="pagination__link">2</a></li>
				<li class="pagination__item"><a href=""
					class="pagination__link"><i class="fas fa-chevron-right"></i></a></li>
			</ul>
		</div>
	</div>
</div>
