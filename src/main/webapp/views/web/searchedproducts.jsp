...
function handlePageLink() {
	...
	fetch('/ProjectWeb/api-allproduct?type=search&search='+ JSON.parse(localStorage.getItem('pageConfig')).search +'&page=' + thisPage + '&sort='+JSON.parse(localStorage.getItem('pageConfig')).sort
